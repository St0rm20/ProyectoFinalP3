...
public class Utilities {
    ...
    public static void crearCopiaRespaldoXML(Object objeto) throws IOException {
        File directory = new File(rutas.getString("RUTA_ARCHIVO_RESPALDO"));
        if (!directory.exists()) {
            directory.mkdirs();
        }
        ...
        String directoryPath = "respaldo/";
        String filePath = directoryPath + "vendedores_" + formattedDateTime + ".xml";

        serializarObjetoXML(filePath, objeto);
    }
